...
def cross_entropy2d(input, target, weight=None, size_average=True, softmax_used=False,reduce=True, reduction='mean', cls_num_list=None):
    n, c, h, w = input.size()
    ...
    if softmax_used:
        ...
        loss = F.cross_entropy(
            input, target, weight=weight, size_average=size_average,reduce=reduce, ignore_index=250, reduction=reduction
        )
    return loss
